 ...
 */
public class Premium_Kullanici_Paneli extends javax.swing.JDialog {
     ...
     */
    public Premium_Kullanici_Paneli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        NormalKullaniciAdiAlani.setText(premium_kullanici_adi);
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("         PREMİUM KULLANICI");
...
//        SarkiDinlenmeSayisiAlani.setText(model.getValueAt(selectedrow, 7).toString());
    ...
    //    premiumKullaniciIslemleri.KullaniciFavorilereMuzikEkle(sarkiAd, sarkiTarih, sarkiSanatci, sarkiAlbum, sarkiTur, sarkiSure, sarkiDinlenmeSayisi);
                   if(premium_kullanici_adi.equalsIgnoreCase("okandemir@gmail.com")){

premiumKullaniciIslemleri.okanKullaniciFavorilereMuzikEkle(sarkiAd, sarkiTarih, sarkiSanatci, sarkiAlbum, sarkiTur, sarkiSure, sarkiDinlenmeSayisi);             }
             else if(premium_kullanici_adi.equalsIgnoreCase("onuraksoy@gmail.com")){

premiumKullaniciIslemleri.onurKullaniciFavorilereMuzikEkle(sarkiAd, sarkiTarih, sarkiSanatci, sarkiAlbum, sarkiTur, sarkiSure, sarkiDinlenmeSayisi);             }
                else   if(premium_kullanici_adi.equalsIgnoreCase("serrasevvalkabak@gmail.com")){

premiumKullaniciIslemleri.serraKullaniciFavorilereMuzikEkle(sarkiAd, sarkiTarih, sarkiSanatci, sarkiAlbum, sarkiTur, sarkiSure, sarkiDinlenmeSayisi);             }
                else   if(premium_kullanici_adi.equalsIgnoreCase("sezenkaya@gmail.com")){

premiumKullaniciIslemleri.sezenKullaniciFavorilereMuzikEkle(sarkiAd, sarkiTarih, sarkiSanatci, sarkiAlbum, sarkiTur, sarkiSure, sarkiDinlenmeSayisi);             }
                   if(premium_kullanici_adi.equalsIgnoreCase("zehracelik@gmail.com")){

premiumKullaniciIslemleri.zehraKullaniciFavorilereMuzikEkle(sarkiAd, sarkiTarih, sarkiSanatci, sarkiAlbum, sarkiTur, sarkiSure, sarkiDinlenmeSayisi);  
                   }  
        Kullanici_Klasik_Muzikleri_Goruntule();
        Kullanici_Jazz_Muzikleri_Goruntule();
        Kullanici_Pop_Muzikleri_Goruntule();
  ...
  if(premium_kullanici_adi.equalsIgnoreCase("okandemir@gmail.com")){
        ...
        if(flag == 1) {
            ...
            premiumKullaniciIslemleri.okanKullaniciMuzikSil(id);
            Kullanici_Klasik_Muzikleri_Goruntule();
        } else if(flag == 2) {
            int id2 = (int) modelJazz.getValueAt(selectedrow2, 0);
            premiumKullaniciIslemleri.okanKullaniciMuzikSil(id2);
            Kullanici_Jazz_Muzikleri_Goruntule(); 
        } else if(flag == 3) {
            int id3 = (int) modelPop.getValueAt(selectedrow3, 0);
            premiumKullaniciIslemleri.okanKullaniciMuzikSil(id3);
            Kullanici_Pop_Muzikleri_Goruntule(); 
        }
        }
        ////////////////////////////////////////////
        ...
        if(flag == 1) {
            int id = (int) modelKlasik.getValueAt(selectedrow, 0);
            premiumKullaniciIslemleri.onurKullaniciMuzikSil(id);
            Kullanici_Klasik_Muzikleri_Goruntule();
        } else if(flag == 2) {
            int id2 = (int) modelJazz.getValueAt(selectedrow2, 0);
            premiumKullaniciIslemleri.onurKullaniciMuzikSil(id2);
            Kullanici_Jazz_Muzikleri_Goruntule(); 
        } else if(flag == 3) {
            int id3 = (int) modelPop.getValueAt(selectedrow3, 0);
            premiumKullaniciIslemleri.onurKullaniciMuzikSil(id3);
            Kullanici_Pop_Muzikleri_Goruntule(); 
        }
        }
...
//        
        if(flag == 1) {
            int id = (int) modelKlasik.getValueAt(selectedrow, 0);
            premiumKullaniciIslemleri.serraKullaniciMuzikSil(id);
            Kullanici_Klasik_Muzikleri_Goruntule();
        } else if(flag == 2) {
            int id2 = (int) modelJazz.getValueAt(selectedrow2, 0);
            premiumKullaniciIslemleri.serraKullaniciMuzikSil(id2);
            Kullanici_Jazz_Muzikleri_Goruntule(); 
        } else if(flag == 3) {
            int id3 = (int) modelPop.getValueAt(selectedrow3, 0);
            premiumKullaniciIslemleri.serraKullaniciMuzikSil(id3);
            Kullanici_Pop_Muzikleri_Goruntule(); 
        }
        }
                 //////////////////////
        ...
        if(flag == 1) {
            int id = (int) modelKlasik.getValueAt(selectedrow, 0);
            premiumKullaniciIslemleri.sezenKullaniciMuzikSil(id);
            Kullanici_Klasik_Muzikleri_Goruntule();
        } else if(flag == 2) {
            int id2 = (int) modelJazz.getValueAt(selectedrow2, 0);
            premiumKullaniciIslemleri.sezenKullaniciMuzikSil(id2);
            Kullanici_Jazz_Muzikleri_Goruntule(); 
        } else if(flag == 3) {
            int id3 = (int) modelPop.getValueAt(selectedrow3, 0);
            premiumKullaniciIslemleri.sezenKullaniciMuzikSil(id3);
            Kullanici_Pop_Muzikleri_Goruntule(); 
        }
        }
                         ////////////
        ...
        if(flag == 1) {
            int id = (int) modelKlasik.getValueAt(selectedrow, 0);
            premiumKullaniciIslemleri.zehraKullaniciMuzikSil(id);
            Kullanici_Klasik_Muzikleri_Goruntule();
        } else if(flag == 2) {
            int id2 = (int) modelJazz.getValueAt(selectedrow2, 0);
            premiumKullaniciIslemleri.zehraKullaniciMuzikSil(id2);
            Kullanici_Jazz_Muzikleri_Goruntule(); 
        } else if(flag == 3) {
            int id3 = (int) modelPop.getValueAt(selectedrow3, 0);
            premiumKullaniciIslemleri.zehraKullaniciMuzikSil(id3);
            Kullanici_Pop_Muzikleri_Goruntule(); 
        }
        }
...
//        
//        KullaniciAdi.setText(modelPremium.getValueAt(selectedrow, 1).toString());
    ...
    private void KullaniciyaGitButonuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KullaniciyaGitButonuActionPerformed
       ...
       secilen_kullanici_adi = modelPremium.getValueAt(selectedrow, 0).toString();
        ...
        Giris_Paneli giris = new Giris_Paneli();
        Gecis_Premium_Paneli gecisPaneli = new  Gecis_Premium_Paneli(giris, true);        
        setVisible(false);
    ...
    private void Top10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Top10ActionPerformed
        ...
        Kullanici_Top_10_Listeleri2 top10 = new Kullanici_Top_10_Listeleri2(giris, true);
        setVisible(false);
    ...
    public void Muzikleri_Goruntule() {
        ...
        sarkilar = premiumKullaniciIslemleri.SarkilariGetir();
    ...
    public void Kullanici_Klasik_Muzikleri_Goruntule() {
     if(premium_kullanici_adi.equalsIgnoreCase("zehracelik@gmail.com")){
        ...
        sarkilar = premiumKullaniciIslemleri.zehraKullaniciKlasikSarkilariGetir();
        ...
        sarkilar = premiumKullaniciIslemleri.sezenKullaniciKlasikSarkilariGetir();
        ...
        sarkilar = premiumKullaniciIslemleri.serraKullaniciKlasikSarkilariGetir();
        ...
        sarkilar = premiumKullaniciIslemleri.onurKullaniciKlasikSarkilariGetir();
       ...
       else  if(premium_kullanici_adi.equalsIgnoreCase("okandemir@gmail.com")){
        modelKlasik.setRowCount(0);
        
        ArrayList<Sarki> sarkilar = new ArrayList<Sarki>();
        
        sarkilar = premiumKullaniciIslemleri.okanKullaniciKlasikSarkilariGetir();
    ...
    public void Kullanici_Jazz_Muzikleri_Goruntule() {
      ...
      if(premium_kullanici_adi.equalsIgnoreCase("zehracelik@gmail.com")){
        ...
        sarkilar = premiumKullaniciIslemleri.zehraKullaniciJazzSarkilariGetir();
        ...
        sarkilar = premiumKullaniciIslemleri.sezenKullaniciJazzSarkilariGetir();
        ...
        sarkilar = premiumKullaniciIslemleri.serraKullaniciJazzSarkilariGetir();
        ...
        sarkilar = premiumKullaniciIslemleri.onurKullaniciJazzSarkilariGetir();
        ...
        sarkilar = premiumKullaniciIslemleri.okanKullaniciJazzSarkilariGetir();
    ...
    public void Kullanici_Pop_Muzikleri_Goruntule() {
        ...
        sarkilar = premiumKullaniciIslemleri.zehraKullaniciPopSarkilariGetir();
        ...
        sarkilar = premiumKullaniciIslemleri.sezenKullaniciPopSarkilariGetir();
        ...
        sarkilar = premiumKullaniciIslemleri.serraKullaniciPopSarkilariGetir();
        ...
        sarkilar = premiumKullaniciIslemleri.onurKullaniciPopSarkilariGetir();
        ...
        sarkilar = premiumKullaniciIslemleri.okanKullaniciPopSarkilariGetir();
    ...
    public void Premium_Kullanicilari_Goruntule() {
        ...
        premiumKullanicilar = premiumKullaniciIslemleri.PremiumKullanicilariGetir();
